...
/**
 * Version prefix string (used in peer ID). Hodlong uses the Azureus-style
 ...
 * @param {Object=} opts
 */
class Hodlong extends EventEmitter {
    constructor (opts = {}) {
        super()
        ...
        if (this.tracker) {
            ...
            if (opts.rtcConfig) {
                // TODO: remove in v1
                console.warn('Hodlong: opts.rtcConfig is deprecated. Use opts.tracker.rtcConfig instead')
                this.tracker.rtcConfig = opts.rtcConfig
            }
            if (opts.wrtc) {
                // TODO: remove in v1
                console.warn('Hodlong: opts.wrtc is deprecated. Use opts.tracker.wrtc instead')
    ...
    download (torrentId, opts, ontorrent) {
        console.warn('Hodlong: client.download() is deprecated. Use client.add() instead')
    ...
    seed (input, opts, onseed) {
        ...
        if (!opts.createdBy) opts.createdBy = `Hodlong/${VERSION_STR}`
...
Hodlong.WEBRTC_SUPPORT = Peer.WEBRTC_SUPPORT
Hodlong.VERSION = VERSION
